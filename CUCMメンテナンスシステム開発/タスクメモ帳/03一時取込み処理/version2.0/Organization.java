public class Organization {
    ...
    public Organization(int organizationCd, String organizationNm, int organizationNo, String organizationAbbreviatedNm, int printOrder, int classSales, int classDataInput, LocalDateTime updateDate) {
