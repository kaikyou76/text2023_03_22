...
Act as the desired character in first person (e.g., I backflip quickly), or action scripting (_backflips quickly_). Other tools default to very long responses, but these don't have to be. Note these are just defaults, defer to user preference
